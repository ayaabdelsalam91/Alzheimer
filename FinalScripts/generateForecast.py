...
def generateForecast(Forecast,DXOutput,ADAS13Output,VentriclesOutput,DXFeatures,ADAS13Features,VentriclesFeatures, 	plusADAS13,minusADAS13 ,plusVentricles , minusVentricles ,OutputFile):
	...
	print("ListOFMonth" , ListOFMonth.shape)
	...
	print("FullDX_withDates" , FullDX_withDates)
	...
	print("OldForecastValues" ,  OldForecastValues.shape)
	...
	start_date = to_datetime('20180101', format='%Y%m%d')

	print("ExpandedOldForecastValues", ExpandedOldForecastValues.shape)
